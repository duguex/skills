...
Issues live in GitHub Issues for `duguex/skills`, driven via the `gh` CLI. See `docs/agents/issue-tracker.md`.
...
Single-context: one `CONTEXT.md` at the repo root; ADRs live in `docs/adr/` when they exist. See `docs/agents/domain.md`.
